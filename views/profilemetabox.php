...
<br />
https://twitter.com/<input type="text" name="wpspin-profile-options-twitter" id="wpspin-profile-options-twitter" value="<?php echo esc_attr( get_post_meta( $object->ID, 'wpspin_profile_twitter', true ) ); ?>" size="10" />
</p>
<p>
<label for="wpspin-profile-options-facebook"><?php _e( "Facebook Username" ); ?></label>
<br />
http://www.facebook.com/<input type="text" name="wpspin-profile-options-facebook" id="wpspin-profile-options-facebook" value="<?php echo esc_attr( get_post_meta( $object->ID, 'wpspin_profile_facebook', true ) ); ?>" size="10" />
</p>
<p>
<?php _e( "DJ ID" ) ?>
<br />
